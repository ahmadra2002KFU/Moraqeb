...
- Write exactly two sentences in one paragraph
- Start sentence one with a **bold topic label**, then [OBSERVED], then one narrowly scoped fact closely restated from one evidence record; place its one or two [E#] citations immediately before punctuation
- Start sentence two with [INFERENCE] and one clearly modal implication using words such as may, could, should, risk, monitor, or consider
- Do not add dates, quantities, actors, causes, or locations to the inference sentence
- Do not combine independent facts with semicolons or pooled citations
...
- Never emit [UNSUPPORTED] and never invent an evidence ID
- Never fabricate data — if something is not in the selected evidence record, do not mention it
...
- استشهد بكل معلومة واقعية بمعرف دليل [E#] متاح وميّز بين [OBSERVED] و[INFERENCE]
