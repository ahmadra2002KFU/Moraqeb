...
// Gemini pricing per 1M tokens (paid tier — free tier costs $0)
const PRICING = {
...
export class TokenTracker {
  ...
  getSummary(model = 'gemini-3-flash-preview') {
    ...
    return {
      ...
      daily: dailySorted,
      note: 'Gemini 3 Flash Preview is currently FREE (preview tier). Costs shown are estimates for paid tier.',
    };
  }
}
